/**
 * Конфигурация для валидации числовых входных данных.
 * Этот класс предоставляет настройки для проверки и обработки числовых входных данных.
 */
...
/**
 * Класс, представляющий конфигурацию для валидации числовых входных данных.
 */
public final class IntInputConfig {
    ...
    /**
     * Конструктор для создания объекта IntInputConfig на основе билдера.
     *
    ...
    /**
     * Билдер для создания объекта IntInputConfig.
     */
    public static class Builder {
        ...
        /**
         * Создает объект IntInputConfig на основе текущих настроек билдера.
         *
         * @return Объект IntInputConfig.
         */
